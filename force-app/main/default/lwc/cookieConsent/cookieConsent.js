...
export default class CookieConsent extends LightningElement {
    ...
    getCookiesAndDropThem(){
        ...
        getCookiesToDrop({'browserId' : this.browserId}).then(data => {
    ...
    verifyBrowserId(){
        ...
        verifyBrowserId({'browserId' : this.browserId}).then(data => {
    ...
    acceptCookies(){
        ...
        createCookieConsentRecords({'browserId' : this.browserId, 'cookiePreferences' : this.cookiePreferences}).then(data => {
